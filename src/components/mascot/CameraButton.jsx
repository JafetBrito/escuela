...
export default function CameraButton() {
  ...
  return (
    <button
      ...
      disabled={capturing}
      className="fixed bottom-4 left-4 z-40 flex h-14 w-14 items-center justify-center rounded-full border-2 border-primary bg-surface text-2xl shadow-lg transition-transform hover:scale-105 disabled:opacity-60 sm:bottom-6 sm:left-6"
