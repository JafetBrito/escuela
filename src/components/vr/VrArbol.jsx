...
// El selector de clase se movió a ./ClassPicker.jsx (componente compartido).
  ...
  return (
    ...
    >
      ...
      {openOverlayId === 'classPicker' && (
        <ClassPicker isAdmin={isAdmin} onSelect={handleSelectAvatarClass} onClose={() => setOpenOverlayId(null)} />
      )}
      ...
      {preTutorial === 'class' && (
        <ClassPicker isAdmin={isAdmin} onSelect={handlePreTutorialClass} />
      )}
      {preTutorial === 'mascot' && (
