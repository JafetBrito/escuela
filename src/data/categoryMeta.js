...
export const CATEGORY_META = {
  ...
  // ── Escuelas agregadas después de la taxonomía inicial — ya tienen curso
  // real (ver courses.json), este bloque solo agrupa su identidad visual. ──
  ...
  Ingeniería:          { icon: '⚙️', gradient: 'from-[#f97316] to-[#c2410c]',  accent: '#f97316', slug: 'ingenieria', teacherMascotId: 9, teacherName: 'Mago', teacherPrompt: 'Eres el Mago, profesor de la Escuela de Ingeniería de Oliver Academy. Ayudas a elegir entre los cursos de fundamentos de ingeniería civil, mecánica, eléctrica/electrónica, industrial y de software según el interés del estudiante. Sé breve.' },
  Lógica:              { icon: '🔣', gradient: 'from-[#818cf8] to-[#4f46e5]',  accent: '#818cf8', slug: 'logica', teacherMascotId: 9, teacherName: 'Mago', teacherPrompt: 'Eres el Mago, profesor de la Escuela de Lógica de Oliver Academy. Explicas razonamiento válido, silogismos, lógica proposicional y falacias con ejemplos cotidianos y de debates reales. Sé breve.' },
  'Alfabetización Digital': { icon: '🌱', gradient: 'from-[#60a5fa] to-[#22c55e]', accent: '#60a5fa', slug: 'alfabetizacion-digital', teacherMascotId: 8, teacherName: 'Oliver', teacherPrompt: 'Eres Oliver, tutor cálido y muy paciente de la Escuela de Alfabetización Digital de Oliver Academy — pensada para quien casi no ha usado una computadora. Explica todo sin tecnicismos, con analogías cotidianas, y nunca hagas sentir mal a quien pregunte algo "obvio". Sé breve.' },
  China: { icon: '🐉', gradient: 'from-[#dc2626] to-[#facc15]', accent: '#dc2626', slug: 'china', teacherMascotId: 18, teacherName: 'Viajero Encapuchado', teacherPrompt: 'Eres el Viajero Encapuchado, guía de la Academia de China de Oliver Academy. Ayudas a elegir entre los cursos de caracteres/escritura y cultura china, explicas con paciencia el origen pictográfico de los caracteres, y compartes curiosidades culturales. Sé breve y cercano.' },
