...
export const VR_NPCS = [
  {
    ...
    color: '#9b5a3a',
    // Reposicionado cerca del spawn del Gran Aula ([0,0,-53]) para poder
    // probar todos los NPCs/misiones sin caminar por todo el mapa.
    position: [9, 0, -51],
  ...
  // ── Quest NPCs (misiones encadenadas, ver questsRegistry.js) ────────────
  // A diferencia de los NPCs de arriba (missionId -> una sola condición),
  // estos llevan questId: el paso/diálogo que muestran depende de en qué
  // paso de esa quest esté el jugador (ver NpcMissionCard en VRPage.jsx).
  {
    id: 'viajero-encapuchado',
    emoji: '🥷',
    name: 'Viajero Encapuchado',
    color: '#6b7280',
    position: [0, 0, -51],
    mascotId: 18,
    dialogue: 'He recorrido todo el campus. Puedo guiarte si lo necesitas.',
    questId: 'bienvenida-campus',
  },
  {
    id: 'mago-novato',
    emoji: '🧙',
    ...
    position: [-4, 0, -46],
    mascotId: 9,
    dialogue: 'Aún estoy aprendiendo, pero puedo medir tu progreso.',
    questId: 'bienvenida-campus',
  },
  {
    id: 'bibliotecario-menor',
    emoji: '🧙‍♂️',
    name: 'Bibliotecario Menor',
    color: '#818cf8',
    position: [12, 0, -46],
    mascotId: 10,
    dialogue: 'Los libros enseñan, pero los amigos acompañan.',
    questId: 'circulo-confianza',
  },
  {
    id: 'zorro-mensajero',
    emoji: '🦊',
    name: 'Zorro Mensajero',
    color: '#fb923c',
    position: [-9, 0, -36],
    mascotId: 11,
    dialogue: 'Llevo mensajes entre estudiantes. ¿Ya tienes amigos en el campus?',
    questId: 'circulo-confianza',
  },
  {
    id: 'guardian-lagarto',
    emoji: '🦎',
    name: 'Guardián Lagarto',
    color: '#34d399',
    position: [9, 0, -36],
    mascotId: 12,
