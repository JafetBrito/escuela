...
export const PLAYER_CLASSES = {
  // ── Clases educativas de Oliver Academy (las "nuestras"). Sus habilidades
  // ya existen en skillRegistry.js (requiredClass: 'programmer', etc.) — aquí
  // se reconectan sus definiciones de clase. Conviven con las de WoW abajo;
  // el usuario decidirá luego cuáles conservar. startSkills = las 2 de Nivel 1.
  programmer: {
    id: 'programmer',
    name: 'Programador',
    icon: '💻',
    ...
    role: 'DPS / Precisión',
    resourceType: 'energy',
    armor: 'Sudadera con capucha',
    weapons: ['Teclado mecánico', 'Terminal'],
    description: 'Maestro del código y la lógica. Velocidad de pensamiento y precisión milimétrica.',
    ...
    baseStats: { str: 12, agi: 22, sta: 16, int: 24, spi: 14 },
    stats: { power: 2, speed: 5, intellect: 5, creativity: 3, wisdom: 2 },
    signatureAbilities: [
      { id: 'fast_compile', name: 'Compilación', description: 'Velocidad +35% y cooldown -35% por 5s.' },
      { id: 'debug_pulse', name: 'Debug Pulse', description: 'Revela bugs ocultos y barreras vulnerables.' },
      { id: 'kernel_crash', name: 'Kernel Crash', description: 'Sobrecarga el sistema del jefe: daño masivo.' },
    ],
    startSkills: ['fast_compile', 'debug_pulse'],
    passiveAura: 'clean_code',
  },
  cyber_strategist: {
    id: 'cyber_strategist',
    ...
    resourceType: 'energy',
    armor: 'Malla de datos',
    weapons: ['Router táctico', 'Exploits'],
    description: 'Táctico de las redes. Analiza amenazas, construye defensas y controla el flujo de información.',
    ...
    baseStats: { str: 14, agi: 18, sta: 18, int: 23, spi: 17 },
    stats: { power: 3, speed: 4, intellect: 5, creativity: 4, wisdom: 3 },
    signatureAbilities: [
      { id: 'tactical_scan', name: 'Escaneo Táctico', description: 'Analiza la amenaza y muestra sus debilidades.' },
      { id: 'proxy_veil', name: 'Proxy Velo', description: 'Bloquea un proyectil entrante automáticamente.' },
      { id: 'zero_day_exploit', name: 'Zero-Day Exploit', description: 'Ignora toda la defensa del jefe.' },
    ],
    startSkills: ['tactical_scan', 'proxy_veil'],
    passiveAura: 'threat_analysis',
  },
  ai_engineer: {
    id: 'ai_engineer',
    ...
    icon: '🧠',
    color: '#a855f7',
    role: 'Predicción / Automatización',
    resourceType: 'mana',
    armor: 'Tela inteligente',
    weapons: ['Modelo neuronal', 'Dataset'],
    description: 'Arquitecto de sistemas que aprenden solos. Convierte datos en predicciones y automatiza lo imposible.',
    ...
    baseStats: { str: 11, agi: 14, sta: 16, int: 24, spi: 20 },
    stats: { power: 2, speed: 3, intellect: 5, creativity: 3, wisdom: 5 },
    signatureAbilities: [
      { id: 'model_inference', name: 'Inferencia', description: 'Predice la respuesta correcta con 70% de certeza.' },
      { id: 'data_weave', name: 'Data Weave', description: 'Organiza información y reduce el cooldown del siguiente skill.' },
      { id: 'singularity_pulse', name: 'Singularity Pulse', description: 'Daño exponencial al jefe.' },
    ],
    startSkills: ['model_inference', 'data_weave'],
    passiveAura: 'predictive_model',
  },
  designer: {
    id: 'designer',
    name: 'Diseñador',
    icon: '🎨',
    color: '#f97316',
    role: 'Arte y funcionalidad',
    resourceType: 'mana',
    armor: 'Atuendo creativo',
    weapons: ['Tableta gráfica', 'Lápiz óptico'],
    description: 'Creador de experiencias que fusiona arte con funcionalidad. La creatividad es su arma.',
    ...
    baseStats: { str: 13, agi: 18, sta: 16, int: 19, spi: 20 },
    stats: { power: 2, speed: 3, intellect: 4, creativity: 5, wisdom: 3 },
    signatureAbilities: [
      { id: 'visual_burst', name: 'Burst Visual', description: 'Destella y confunde al enemigo por 2 segundos.' },
      { id: 'form_shift', name: 'Form Shift', description: 'Cambia la perspectiva y revela un camino oculto.' },
      { id: 'grand_design', name: 'Grand Design', description: 'Rediseña el campo de batalla a tu favor.' },
    ],
    startSkills: ['visual_burst', 'form_shift'],
    passiveAura: 'design_sense',
  },
  philosopher: {
    id: 'philosopher',
    name: 'Filósofo',
    icon: '📜',
    color: '#eab308',
    role: 'Sabiduría y ética',
    resourceType: 'mana',
    armor: 'Túnica del pensador',
    weapons: ['Argumento', 'Lógica'],
    description: 'Pensador crítico que cuestiona todo. La sabiduría y la ética son sus herramientas.',
    ...
    baseStats: { str: 11, agi: 12, sta: 15, int: 22, spi: 24 },
    stats: { power: 2, speed: 2, intellect: 4, creativity: 3, wisdom: 5 },
    signatureAbilities: [
      { id: 'socratic_parry', name: 'Réplica Socrática', description: 'Devuelve la pregunta al jefe, ganando tiempo.' },
      { id: 'axiom_pulse', name: 'Pulso Axioma', description: 'Principio irrefutable: daño garantizado al jefe.' },
      { id: 'eternal_logos', name: 'Logos Eterno', description: 'La verdad absoluta como arma: daño crítico.' },
    ],
    startSkills: ['socratic_parry', 'axiom_pulse'],
    passiveAura: 'critical_thinking',
  },
